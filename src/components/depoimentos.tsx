...
export function Depoimentos({ src, alt, autor, anoCliente }: depoimentoProps) {
    return (
        <section className="flex mb-20">
            ...
            <div className="flex mx-64 gap-6 mt-14">
                <Image src={src} alt={alt} className="max-w-2/5 z-10" width={300} height={100} />
                <div className="flex flex-col w-3/5">
                    <h2 className="text-zinc-900 text-3xl font-bold font-title mb-4 pt-6">Não acredite em nós <br/> veja o que os clientes tem a dizer</h2>
                    <div className="flex gap-4">
                        <Quote className="w-60 rounded-full bg-yellow-300 size-9 p-2" color="white" />
                        <p
                            className="text-zinc-400 mb-1 text-sm font-montserrat"
