...
export default function Produto5() {
    ...
    return (
        <section className="bg-linhas">
            ...
            <section className="justify-end py-8 flex">
                <Image className="absolute h-auto top-12 mt-16 left-0 z-10" src={produto.img} alt={`Imagem do produto ${produto.id}`} width={300} height={300} />
