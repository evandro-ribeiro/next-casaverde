...
export default function Produto6() {
    ...
    return (
        <section className="bg-linhas">
            ...
            <section className="justify-end py-8 flex">
                <Image className="absolute h-auto top-12 mt-20 left-0 z-10" src={produto.img} alt={`Imagem do produto ${produto.id}`} width={300} height={300} />
                <Image className="absolute left-0 top-20 mt-8 z-0" src="/ofertas/splash-chamada-ofertas.svg" alt="Imagem de um borrão de tinta amarela" width={400} height={500} />
