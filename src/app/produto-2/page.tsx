    ...
    return (
        <section className="bg-linhas">
            ...
            <section className="justify-end py-8 flex">
                <Image className="absolute top-20 mt-10 left-20 z-10 h-auto" src={produto.img} alt={`Imagem do produto ${produto.id}`} width={600} height={300} />
                <Image className="absolute left-0 top-24 mt-8 z-0" src="/ofertas/splash-chamada-ofertas.svg" alt="Imagem de um borrão de tinta amarela" width={400} height={500} />
