    ...
    return (
        <section className="bg-linhas">
            ...
            <section className="justify-center md:justify-end md:py-4 flex h-96 md:h-fit">
                <Image className="absolute top-20 mt-28 md:mt-10 md:left-20 z-10 md:h-auto" src={produto.img} alt={`Imagem do produto ${produto.id}`} width={600} height={300} />
                <Image className="absolute -left-52 md:left-0 md:top-24 md:mt-8 -z-10" src="/ofertas/splash-chamada-ofertas.svg" alt="Imagem de um borrão de tinta amarela" width={400} height={500} />
                <div className="flex flex-col items-center mt-9 max-w-96 md:mr-64 gap-2 z-10">
                    <h1 className="text-zinc-900 text-4xl md:text-6xl font-bold font-title z-10">{produto.title}</h1>
                    <p className="text-zinc-400 mb-1 text-md font-bold">R$ {produto.price.toFixed(2)}</p>
                    <p className="text-zinc-400 mb-1 text-sm hidden md:block">{produto.description}</p>
            ...
            <section className="bg-white flex h-fit w-full pb-20">
                <div className="absolute bg-white p-9 w-full z-20" />
                <div className="flex flex-col items-center md:items-start mt-96 md:w-2/5 md:mt-20 md:ml-52">
                    <h2 className="text-zinc-900 text-3xl font-bold font-title mb-4 mt-4">Descrição do produto</h2>
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-5 mt-4">
                        <Hash className="w-16 rounded-full bg-yellow-300 size-10 p-2" color="white" />
                ...
                <Image className="absolute w-3/4 mx-14 md:right-28 md:mr-28 md:mt-20 md:w-3/12" src="/ofertas/img-descricao-produto.png" alt="Planta em vaso de vidro com água" width={400} height={100} />
            </section>
            <div className="absolute bg-white p-20 w-full z-0" />
            <div>
                <h2 className="absolute z-10 right-14 mr-56 mt-20 text-zinc-900 text-3xl font-bold font-title hidden md:block">Não acredite em nós <br/> veja o que os clientes tem a dizer</h2>
